...
return  array(
    ...
    'shared'=> array(
        ...
        NEWS_PARSER_PLUGIN_SLUG . '-main'=>NEWS_PARSER_PLUGIN_URL.'/public/css/127-'.NEWS_PARSER_PLUGIN_VERSION.'.css',
    ),
    ...
    $menu_config->menu->subs[1]->menu_slug=>array(
        NEWS_PARSER_PLUGIN_SLUG . '-parser-page'=>NEWS_PARSER_PLUGIN_URL.'/public/css/parser_page-'.NEWS_PARSER_PLUGIN_VERSION.'.css'
    ),
    $menu_config->menu->subs[2]->menu_slug=>array(
        NEWS_PARSER_PLUGIN_SLUG . '-autopilot'=>NEWS_PARSER_PLUGIN_URL.'/public/css/autopilot-'.NEWS_PARSER_PLUGIN_VERSION.'.css'
    ),
