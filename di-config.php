...
return array(
    ...
    Parser\HTMLPatternParser::class=>object(Parser\HTMLPatternParser::class)->constructor(get(Utils\GutenbergAdapter::class)),
    Menu\Admin\MenuPage::class=>object(Menu\Admin\MenuPage::class)->constructor(object(Utils\MenuConfig::class)),
    Controller\PostController::class=>object(Controller\PostController::class)->constructor(object(Parser\HTMLPatternParser::class),get(Utils\ResponseFormatter::class)),
